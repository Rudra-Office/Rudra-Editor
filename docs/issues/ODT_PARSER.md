...
| ODT-04 | TOC source element attributes lost on round-trip | `content_parser.rs` | 857-927 | OPEN |
| ODT-05 | Nested list structures flattened — multi-paragraph list items lose grouping | `content_parser.rs` | 773-801 | OPEN |
...
| ODT-10 | Missing footnote/endnote parsing | `content_parser.rs` | — | OPEN |
| ODT-11 | SVG/drawing objects other than images silently dropped | `content_parser.rs` | 657-725 | OPEN |
| ODT-12 | Bookmark cross-references not resolved after round-trip | `content_parser.rs` | 418-511 | OPEN |
