...
export function createMenuBar(api) {
  ...
  var menus = {
    ...
    'Format': [
      { label: 'Bold', icon: 'format_bold', shortcut: '⌘B', action: function() { api.put_TextPrBold(!window._fmtState.bold); } },
      { label: 'Italic', icon: 'format_italic', shortcut: '⌘I', action: function() { api.put_TextPrItalic(!window._fmtState.italic); } },
      { label: 'Underline', icon: 'format_underlined', shortcut: '⌘U', action: function() { api.put_TextPrUnderline(!window._fmtState.underline); } },
      { label: 'Strikethrough', icon: 'strikethrough_s', action: function() { api.put_TextPrStrikeout(!window._fmtState.strikeout); } },
      { sep: true },
